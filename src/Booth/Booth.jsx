            ...
            <div className='booth-content-container'>
                ...
                <div className='booth-content2'>
                    ...
                    <span>
                        ...
                        2. 오후 <strong>6시</strong> 이름과 전화번호로 로그인 후 매칭결과를 확인해주세요. <br></br>
                        ...
                        📌 안내사항
                        <br></br>
                        미팅에 참여하지 않아도 팔찌는 별도 구매할 수 있습니다<br></br>
                        개인정보는 본인확인 용도로만 쓰이며 축제마감 후 삭제됩니다.<br></br>
                        남녀 비율로 인해 매칭이 안 될 경우에는 1,000원 환불해 드립니다.
                        <br></br>
                        <br></br>
                        ⏰ 부스운영 시간
                        <br></br>
